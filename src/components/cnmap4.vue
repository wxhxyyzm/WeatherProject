...
// 假设这是您想要标记的经纬度坐标
const starCoordinate = [113.2, 23.1291]; // 杭州的经纬度
export default {
  data() {
    return {
      locationvalue: {
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      const chart = $echarts.init(document.getElementById("cnmapp4"), roma);
      chart.setOption({
        grid: {
          left: "10%",
          bottom: "10%",
