  ...
  watch: {
    locationvalue: function (newvalue, oldvalue) {
      if (oldvalue !== newvalue) {
        ...
        const yChart = echarts.init(document.getElementById("cnmapp"), roma);
        starCoordinate[0] = this.locationvalue.LONGITUDE;
        starCoordinate[1] = this.locationvalue.LATITUDE;
